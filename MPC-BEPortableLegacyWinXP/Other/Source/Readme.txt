...
user in an INI file next to MPC-BEPortable.exe called MPC-BEPortable.ini.
...
copy AppNamePortable.ini from this directory to MPC-BEPortable.ini next to
MPC-BEPortable.exe. The options in the INI file are as follows:
